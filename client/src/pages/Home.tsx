        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.div 
              ...
              transition={{ delay: 0.2 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-300 via-indigo-400 to-purple-500 bg-clip-text text-transparent mb-4">
                Make a Payment
              </h2>
              ...
              >
                {[
                  ...
                  >
                    <div className="p-4 bg-white/5 rounded-2xl border-2 border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
            ...
            <AnimatePresence mode="wait">
              {isLoading ? (
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                >
                  <Card className="p-8 backdrop-blur-lg bg-white/10 border-purple-500/20 rounded-[2rem]">
                ...
                >
                  <Card className="p-8 backdrop-blur-lg bg-white/10 border-purple-500/20 rounded-[2rem]">
                    <div className="flex flex-col items-center text-center space-y-6">
                      ...
                      >
                        <AlertCircle className="w-20 h-20 text-purple-400" />
                      </motion.div>
                      <div>
                      ...
                      <Button
                        variant="outline"
                        className="mt-6 border-purple-500/20 text-purple-400 hover:bg-purple-500/10 rounded-xl px-6 py-3 text-lg"
